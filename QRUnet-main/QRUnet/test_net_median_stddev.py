...
def main():
    ...
    parser.add_argument(
        ...
        default='/ImagePTE1/akrami/MRI_Recon_results/qr_0.5/fnet-50.hdf5',
        help="The path to a trained FNet")
    parser.add_argument(
        '-n_ql', '--net_path_ql', type=str,
        default='/ImagePTE1/akrami/MRI_Recon_results/qr_0.85/fnet-50.hdf5',
        help="The path to a trained FNet")
    parser.add_argument(
        '-n_qu', '--net_path_qu', type=str,
        default='/ImagePTE1/akrami/MRI_Recon_results/qr_0.15/fnet-50.hdf5',
        help="The path to a trained FNet")
    parser.add_argument(
        '-d',
        '--data_path',
